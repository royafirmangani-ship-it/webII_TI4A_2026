...
<div class="container mt-5">
    <div class="d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="tambah_mahasiswa.php" class="btn btn-primary btn-sm shadow-sm">
        ...
        <table class="table table-striped table-hover shadow-sm">
            ...
            <?php while($row = mysqli_fetch_assoc($mahasiswa)) : ?>
                <tr>
                    ...
                    <td><?= $row['email']; ?></td>
                    <td>
                    <a href="edit_mahasiswa.php?id=1" class="btn btn-warning btn-sm">Edit</a>
                    <a href="hapus_mahasiswa.php?id=<?= $row['id']; ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus?')">Hapus</a>      
                    </td>
                </tr> 
            <?php $i++; ?>
            <?php endwhile; ?>
